...
import { message, Upload, Row, Col, Input, Icon, DatePicker, Button, Tooltip, Popconfirm } from 'antd';

import BreadcrumbCustom from '../common/BreadcrumbCustom';
import data from './request/staffdata.json';
import CollectionCreateForm from './StaffForm';
...
export default class Staff extends Component{
    ...
    render(){
        ...
        return(
            <div>
                <BreadcrumbCustom paths={['Home','Staff']}/>
                <div className='formBody'>
                    <Row gutter={16}>
                        ...
                        <div className='function' >
                            <Button size="large" name='plus' onClick={this.CreateItem} type="primary"  style={{marginLeft:'10px'}}>Add New Member</Button>
                    ...
                    />
                    {isUpdate?
                        <CollectionCreateForm ref={this.saveFormRef} visible={visible} onCancel={this.handleCancel} onCreate={this.handleUpdate} title="Edit Staff Member" okText="Complete"
                    /> : <CollectionCreateForm ref={this.saveFormRef} visible={visible} onCancel={this.handleCancel} onCreate={this.handleCreate} title="New Staff Member" okText="Create"
                    />}
                </div>
            </div>
        )
